...
for phoneme in unique_labels:
	(mfcc_models[phoneme])['2']=pickle.load(open("./models/"+phoneme+"/energy_mfcc_2.pkl", 'rb'))
	(mfcc_models[phoneme])['4']=pickle.load(open("./models/"+phoneme+"/energy_mfcc_4.pkl", 'rb'))
	(mfcc_models[phoneme])['8']=pickle.load(open("./models/"+phoneme+"/energy_mfcc_8.pkl", 'rb'))
	(mfcc_models[phoneme])['16']=pickle.load(open("./models/"+phoneme+"/energy_mfcc_16.pkl", 'rb'))
	(mfcc_models[phoneme])['32']=pickle.load(open("./models/"+phoneme+"/energy_mfcc_32.pkl", 'rb'))
	(mfcc_models[phoneme])['64']=pickle.load(open("./models/"+phoneme+"/energy_mfcc_64.pkl", 'rb'))
	(mfcc_models[phoneme])['128']=pickle.load(open("./models/"+phoneme+"/energy_mfcc_128.pkl", 'rb'))
	(mfcc_models[phoneme])['256']=pickle.load(open("./models/"+phoneme+"/energy_mfcc_256.pkl", 'rb'))

	(mfcc_models_w[phoneme])['2']=pickle.load(open("./models/"+phoneme+"/mfcc_2.pkl", 'rb'))
	(mfcc_models_w[phoneme])['4']=pickle.load(open("./models/"+phoneme+"/mfcc_4.pkl", 'rb'))
	(mfcc_models_w[phoneme])['8']=pickle.load(open("./models/"+phoneme+"/mfcc_8.pkl", 'rb'))
	(mfcc_models_w[phoneme])['16']=pickle.load(open("./models/"+phoneme+"/mfcc_16.pkl", 'rb'))
	(mfcc_models_w[phoneme])['32']=pickle.load(open("./models/"+phoneme+"/mfcc_32.pkl", 'rb'))
	(mfcc_models_w[phoneme])['64']=pickle.load(open("./models/"+phoneme+"/mfcc_64.pkl", 'rb'))
	(mfcc_models_w[phoneme])['128']=pickle.load(open("./models/"+phoneme+"/mfcc_128.pkl", 'rb'))
	(mfcc_models_w[phoneme])['256']=pickle.load(open("./models/"+phoneme+"/mfcc_256.pkl", 'rb'))
	
	mfcc_delta_models[phoneme]=pickle.load(open("./models/"+phoneme+"/energy_delta.pkl", 'rb'))
	mfcc_delta_models_w[phoneme]=pickle.load(open("./models/"+phoneme+"/delta.pkl", 'rb'))

	mfcc_delta_delta_models[phoneme]=pickle.load(open("./models/"+phoneme+"/energy_delta_delta.pkl", 'rb'))
	mfcc_delta_delta_models_w[phoneme]=pickle.load(open("./models/"+phoneme+"/delta_delta.pkl", 'rb'))
